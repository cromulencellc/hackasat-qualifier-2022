...
class digital_freq_lock(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Digital Freq Lock", catch_exceptions=True)
        ...
        ##################################################
        self.sps = sps = 100
        self.samp_rate = samp_rate = 1200*100
        self.rolloff = rolloff = 0.35
        self.noise_amp = noise_amp = .01
        self.freq_offset = freq_offset = .4
        ...
        self._noise_amp_range = Range(0, 1, 0.01, .01, 200)
        self._noise_amp_win = RangeWidget(self._noise_amp_range, self.set_noise_amp, "Channel Noise", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_grid_layout.addWidget(self._noise_amp_win, 0, 0, 1, 1)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._freq_offset_range = Range(-.5, .5, 0.01, .4, 200)
        ...
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._freq_bw_range = Range(0, 3, 0.001, 0, 200)
        self._freq_bw_win = RangeWidget(self._freq_bw_range, self.set_freq_bw, "'freq_bw'", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.notebook_layout_1.addWidget(self._qtgui_time_sink_x_0_0_win)
        ...
        self.notebook_layout_1.addWidget(self._qtgui_time_sink_x_0_win)
        ...
        self.digital_psk_mod_0 = digital.psk.psk_mod(
            ...
            verbose=False,
            log=False)
        self.digital_fll_band_edge_cc_0 = digital.fll_band_edge_cc(sps, rolloff, int(samp_rate/1000), freq_bw)
        self.digital_costas_loop_cc_0 = digital.costas_loop_cc(3.14/100, 3, False)
        ...
        self.analog_random_source_x = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 256, 10000000))), True)
        ...
        self.connect((self.digital_costas_loop_cc_0, 0), (self.digital_fll_band_edge_cc_0, 0))
